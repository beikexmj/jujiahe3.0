...
- (void)viewDidLoad {
    ...
    if (_comFromFlag.integerValue == 1) {
...
- (void)backBarButtonItem {
    ...
    [leftButton setImage:[UIImage imageNamed:@"icon_back_gray"] forState:UIControlStateNormal];
...
- (CGFloat)tableView:(UITableView *)tableView heightForHeaderInSection:(NSInteger)section {
    if (_HeaderSectionTotal == 3 && section == 0) {
        return 0;
    }else{
        return 40;
    }
