...
//    cell.selectDate = _selectDate;
    cell.continueSignMark = NO;
    if (_selectDateArray) {
        for (NSDate *date in _selectDateArray) {
            if ([[YXDateHelpObject manager] isSameDate:date AnotherDate:cellDate]) {
                cell.selectDate = cellDate;
            }
        }
        
    }
    for (NSDate *date in _continueSignDateArray) {
        if ([[YXDateHelpObject manager] isSameDate:date AnotherDate:cellDate]) {
            cell.continueSignMark = YES;
        }
    }
